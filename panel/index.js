...
<div class="inise">
<p class="mdc-typography--body1">Songeditor</p>
  ...
  function loadSong(data, parent) {
    ...
    for (let key in data) {
      ...
      try {
        ...
        var videopreview = song.urls[`jmcs://jd-contents/${song.mapName}/${song.mapName}_MapPreviewNoSoundCrop_LOW.vp9.webm`] || "https://cdn.discordapp.com/attachments/1156153836994580500/1162953425483464775/New_Project_120_E732AD7.mp4"
      } catch (rtt) { }
      songList.push({
        title: song.title,
        artist: song.artist,
